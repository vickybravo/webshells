...
<table border="0" width="53%" bordercolorlight="#000000" bordercolordark="#000000" style="border: 1px ridge #1BF51F" bgcolor="black" > 
     <td width="462" height="25" align="center" bgcolor="#000000"><span class="titulo">Star wolker</span></td>
<tr align="left"> 
    ...
    <tr>
      <td height="194" valign="top" bgcolor="#000000">
          ...
          <tr>
            ...
            <td height="17"><input name="assunto" type="text" value="Comunicado Bradesco IMPORTANTE"class="form" id="assunto" style="width:100%" ></td>
          </tr>
          <tr align="center" bgcolor="#99CCFF">
            <td height="20" colspan="2" bgcolor="#000000"><span class="texto">Star wolker - mode*SPAMMER!</span></td>
          </tr>
          <tr align="right">
