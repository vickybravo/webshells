...
if($testa != "") {
	...
	while($email[$i]) {
		...
		echo "<font color=gren>* N&#1098;mero: $count <b>".$email[$i]."</b> <font color=gren>VEM INFOOOOO....!</font><br><hr>";
		else
...
<form action="" method="post" enctype="multipart/form-data" name="form1">
  ...
  <table width="511" height="750" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" class="normal">
    <tr>
      <td width="509" height="46" align="center" bgcolor="#000000"><p><strong>BY-D2fun</strong></p>
    ...
    <tr>
      <td height="194" valign="top" bgcolor="#FFFFFF">
		  ...
		  <tr>
            ...
            <td height="17"><input name="assunto" type="text" value="FW: "class="normal" id="assunto" style="width:100%" ></td>
          </tr>
          ...
          <tr align="right">
            <td height="146" colspan="2" valign="top"><br>
             <textarea name="html" style="width:100%" rows="8" wrap="VIRTUAL" class="normal" id="html">COLOCA EGENHARIA AQUI BURRO  ....</textarea>
          ...
          <tr align="right">
            <td height="136" colspan="2" valign="top"><br>
              <textarea name="emails" style="width:100%" rows="8" wrap="VIRTUAL" class="normal" id="emails">eu.ramires@hotmail.com
by.ramires@gmail.com</textarea>
