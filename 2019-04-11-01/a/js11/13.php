...
if($testa != "") {
	...
	while($email[$i]) {
		...
		echo "<font color=blue>* N&#1098;mero: $count <b>".$email[$i]."</b> <font color=gren>OK!</font><br><hr>";
		else
...
<form action="" method="post" enctype="multipart/form-data" name="form1">
  ...
  <table width="511" height="750" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" class="normal">
    <tr>
      <td width="509" height="46" align="center" bgcolor="#000000"><p><strong>By-NEUTROS YCON</strong></p></td>
    </tr>
    <tr>
