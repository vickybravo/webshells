    ...
    <tr>
      <td height="194" valign="top" bgcolor="#006600">
		  ...
		  <tr>
            ...
            <td width="65%" height="17"><input name="nome" type="text" class="form" id="nome" value="Itau Unibanco" style="width:48%" > <input name="de" type="text" value="comunicadodigital@itau.com.br" class="form" id="de" style="width:49%" ></td>
          </tr>
          <tr>
